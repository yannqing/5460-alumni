...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "商家发布话题请求DTO")
public class PublishTopicDto implements Serializable {
    ...
    @Schema(description = "主办方ID（店铺ID）", requiredMode = Schema.RequiredMode.REQUIRED)
