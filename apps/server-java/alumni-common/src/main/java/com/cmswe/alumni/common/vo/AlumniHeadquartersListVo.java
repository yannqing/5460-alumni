...
@AllArgsConstructor
@NoArgsConstructor
@Schema(name = "AlumniHeadquartersListVo", description = "校友总会基本信息VO")
public class AlumniHeadquartersListVo implements Serializable {
    ...
    public static AlumniHeadquartersListVo objToVo(AlumniHeadquarters alumniHeadquarters) {
        if (alumniHeadquarters == null) {
            return null;
        }
        AlumniHeadquartersListVo vo = new AlumniHeadquartersListVo();
