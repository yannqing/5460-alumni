...
@AllArgsConstructor
@NoArgsConstructor
@Schema(name = "SuperAdminMerchantApprovalVo", description = "超级管理员查看商户审批记录返回 VO")
public class SuperAdminMerchantApprovalVo implements Serializable {
     ...
     *
     * @param merchant 商户实体
     * @return SuperAdminMerchantApprovalVo
     */
    public static SuperAdminMerchantApprovalVo objToVo(Merchant merchant) {
        if (merchant == null) {
            return null;
        }
