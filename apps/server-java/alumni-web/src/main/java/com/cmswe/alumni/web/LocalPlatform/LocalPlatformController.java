...
public class LocalPlatformController {
        ...
        public BaseResponse<List<OrganizationTreeVo>> getOrganizationTree(
                ...
                List<OrganizationTreeVo> organizationTree = localPlatformService
                                .getOrganizationTree(request.getLocalPlatformId());
        ...
        public BaseResponse<List<OrganizationTreeV2Vo>> getOrganizationTreeV2(
                ...
                List<OrganizationTreeV2Vo> organizationTree = localPlatformService
                                .getOrganizationTreeV2(request.getLocalPlatformId());
        ...
        public BaseResponse<PageVo<AlumniAssociationListVo>> getAlumniAssociationsByPlatformId(
                ...
                PageVo<AlumniAssociationListVo> pageVo = localPlatformService.getAlumniAssociationsByPlatformId(
                                queryDto,
                                currentUserId);
                return ResultUtils.success(Code.SUCCESS, pageVo, "分页查询成功");
        }
