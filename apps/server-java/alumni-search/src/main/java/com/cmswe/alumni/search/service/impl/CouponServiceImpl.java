...
import com.cmswe.alumni.search.mapper.SearchAlumniAssociationMemberMapper;
...
public class CouponServiceImpl extends ServiceImpl<CouponMapper, Coupon> implements CouponService {
    ...
    @Resource
    private SearchAlumniAssociationMemberMapper searchAlumniAssociationMemberMapper;
    ...
    public UserCouponVo claimCoupon(Long wxId, ClaimCouponDto claimCouponDto) {
        ...
        if (coupon.getIsAlumniOnly() != null && coupon.getIsAlumniOnly() == 1) {
            ...
            String associationIdsStr = merchant.getAlumniAssociationId();
            if (StringUtils.isBlank(associationIdsStr)) {
                // 如果商户没有关联任何校友会，则退回到基本的校友认证检查
                ...
                if (associationIds == null || associationIds.isEmpty()) {
                    ...
                    Long count = searchAlumniAssociationMemberMapper.selectCount(
