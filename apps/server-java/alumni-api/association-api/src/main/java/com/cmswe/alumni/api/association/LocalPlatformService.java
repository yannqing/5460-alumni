...
public interface LocalPlatformService extends IService<LocalPlatform> {
         ...
         * @return 邀请结果
         */
        boolean inviteMember(Long localPlatformId, Long wxId, Long roleOrId, String username, String roleName, String contactInformation, String socialDuties, Integer isShow);
        ...
        /**
         * 根据手机号和姓名绑定校促会预设成员（假人转真人）
         * 查找 wx_id 为空且 contact_information、username 分别与手机号、姓名匹配的预设成员，为其绑定 wxId
         *
         * @param phone 用户手机号
