...
@AllArgsConstructor
@NoArgsConstructor
@Schema(name = "UpdateCouponDto", description = "更新优惠券请求DTO")
public class UpdateCouponDto implements Serializable {
    ...
    @Schema(description = "优惠券类型：1-折扣券 2-满减券 3-礼品券", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "优惠值", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "发行总量（-1表示不限量）", requiredMode = Schema.RequiredMode.REQUIRED)
    private Integer totalQuantity;

    /**
     * 每人限领数量（0表示不限）
     */
    @Schema(description = "每人限领数量（0表示不限）")
